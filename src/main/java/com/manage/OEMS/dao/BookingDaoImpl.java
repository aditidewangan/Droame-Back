...
public class BookingDaoImpl implements BookingDao {
	...
	public Booking addBooking(Booking booking) {
		Object[] args = { booking.getBookingId(), booking.getDate(), booking.getGuestCount(), booking.getEventName(), booking.getEventCost(), booking.getTotalCost(),
				booking.getPaymentStatus(), booking.getMemberId(), booking.getVenueId(), booking.getDelStatus() };

		String query = "INSERT INTO booking (booking_id, date, guest_count, event_name,"
				+ " event_cost, total_cost, payment_status, member_id, venue_id, del_status)"
				+ "VALUES (?,?,?,?,?,?,?,?,?,?)";
	...
	public BookingDetail getSingleBooking(int bookingId) {
		String query = "select booking.member_id,booking.venue_id,booking.booking_id,booking.date,booking.guest_count,booking.event_name,"
				+ "booking.event_cost,booking.total_cost,booking.payment_status,"

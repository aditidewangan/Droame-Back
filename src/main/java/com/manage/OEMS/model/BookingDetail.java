...
public class BookingDetail {
	...
	public BookingDetail(int venueId, int memberId, int bookingId, Date date, int guestCount, String eventName, int eventCost,
	...
	public String toString() {
		return "BookingDetail [venueId=" + venueId + ", memberId=" + memberId + ", bookingId=" + bookingId + ", date="
				+ date + ", guestCount=" + guestCount + ", eventName=" + eventName
				+ ", eventCost=" + eventCost + ", totalCost=" + totalCost + ", paymentStatus=" + paymentStatus
